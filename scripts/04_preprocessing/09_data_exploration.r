# post normalisation data exploration for GSE87571
...
#save PCA plot
pdf("results/qc/post_norm_pca_plot.pdf")
...
write.csv(post_norm_summary, "results/qc/post_normalisation_summary.csv", row.names = FALSE)
