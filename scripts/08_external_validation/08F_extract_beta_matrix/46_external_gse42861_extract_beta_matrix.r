# This script extracts the final beta matrix from the filtered GSE42861 MethylationSet object.
...
filtered_mset_file <- readRDS("data/GSE42861/mset_normalised_filtered_annotation_crossreactive_cpg_autosomal.rds")
...
saveRDS(beta_matrix, "data/GSE42861/beta_matrix.rds")
...
write.csv(
  ...
  "results/external_validation/qc/gse42861_final_matrix_summary.csv",
  row.names = FALSE
)
