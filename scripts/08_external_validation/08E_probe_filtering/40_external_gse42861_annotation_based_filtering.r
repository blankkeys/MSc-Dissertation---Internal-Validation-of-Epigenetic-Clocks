# SNP-based probe filtering for GSE42861
...
mSet <- readRDS("data/GSE42861/mset_normalised_filtered.rds")
...
saveRDS(
  mSet_filtered,
  "data/GSE42861/mset_normalised_filtered_annotation.rds"
)
...
write.csv(
  removed_probes,
  "results/external_validation/qc/gse42861_annotation_removed_probes.csv",
  row.names = FALSE
)
...
write.csv(
  ...
  "results/external_validation/qc/gse42861_annotation_probe_filtering_summary.csv",
  row.names = FALSE
)
