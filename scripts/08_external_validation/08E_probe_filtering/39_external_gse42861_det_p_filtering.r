...
saveRDS(
  mSet_filtered,
  "data/GSE42861/mset_normalised_filtered.rds"
)
...
write.csv(
  ...
  "results/external_validation/qc/gse42861_probe_filtering_summary.csv",
  row.names = FALSE
)
