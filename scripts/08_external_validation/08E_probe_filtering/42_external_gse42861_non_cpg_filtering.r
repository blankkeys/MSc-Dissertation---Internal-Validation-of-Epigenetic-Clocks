# Non-CpG probe filtering for GSE42861
# This removes probes with IDs that do not start with cg
# The filtered object is saved for autosomal filtering

library(minfi)

input_mset_file <- "data/GSE42861/mset_normalised_filtered_annotation_crossreactive.rds"
output_mset_file <- "data/GSE42861/mset_normalised_filtered_annotation_crossreactive_cpg.rds"
summary_file <- "results/external_validation/qc/gse42861_non_cpg_filtering_summary.csv"
