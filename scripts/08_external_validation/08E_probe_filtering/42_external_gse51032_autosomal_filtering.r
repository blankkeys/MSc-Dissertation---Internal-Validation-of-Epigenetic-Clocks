# Autosomal probe filtering for GSE51032
...
input_mset_file <- "data/GSE51032/mset_normalised_filtered_annotation_crossreactive_cpg.rds"
annotation_file <- "data/annotation/HM450.hg19.manifest.tsv.gz"

output_mset_file <- "data/GSE51032/mset_normalised_filtered_annotation_crossreactive_cpg_autosomal.rds"
summary_file <- "results/external_validation/qc/gse51032_autosomal_filtering_summary.csv"
