# Cross-reactive probe filtering for GSE51032.
...
mSet <- readRDS("data/GSE51032/mset_normalised_filtered_annotation.rds")
...
saveRDS(
  mSet_filtered,
  "data/GSE51032/mset_normalised_filtered_annotation_crossreactive.rds"
)
...
write.csv(
  removed_probes,
  "results/external_validation/qc/gse51032_cross_reactive_removed_probes.csv",
  row.names = FALSE
)
...
write.csv(
  ...
  "results/external_validation/qc/gse51032_cross_reactive_probe_filtering_summary.csv",
  row.names = FALSE
)
