# post normalisation data exploration for GSE42861

library (minfi)

#load the methylation set from normalisation
mSet <- readRDS("data/GSE42861/mset_normalised.rds")
...
pdf("results/external_validation/qc/gse42861_post_norm_density_plots.pdf")
densityPlot(beta_values,
sampGroups = NULL,  # no grouping variable, so all samples will be plotted together
main = "GSE42861 post-normalisation beta value density"
)
dev.off()
...
#save PCA plot
pdf("results/external_validation/qc/gse42861_post_norm_pca_plot.pdf")
...
xlab = "PC1",
ylab = "PC2",
main = "GSE42861 post-normalisation PCA",
pch = 16
)
...
write.csv(post_norm_summary, "results/external_validation/qc/gse42861_post_normalisation_summary.csv", row.names = FALSE)
