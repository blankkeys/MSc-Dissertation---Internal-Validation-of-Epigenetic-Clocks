# Sample QC for GSE51032

library(minfi)

# Load the raw RGChannelSet created by 26/33_import_external_gse51032_with_minfi.r
...
saveRDS(detP, "data/GSE51032/sample_detection_pvalues.rds")
...
write.csv(
  sample_qc,
  "results/external_validation/qc/gse51032_sample_qc_summary.csv",
  row.names = FALSE
)
